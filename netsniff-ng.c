 ...
 * acts as a raw socket sniffer with kernelspace bpf, zero copy mode 
 * (rx ring) and fast scatter-gather i/o
 *
 ...
 *       order to use this.
 *
 * Compile with: gcc -lpthread -O3 -o netsniff-ng ./netsniff-ng.c
 *
 * Changelog:
 *     0.5.1:
 *         - Init
...
void help()
{
    ...
    printf("acts as a raw socket sniffer with kernelspace bpf, zero copy mode (rx ring) and \nfast scatter-gather i/o.\n");
    printf("\n");
