...
static inline void refresh_counters()
{
...
static inline void hold_softirq_pthread()
{
    sigset_t block_mask;
...
static inline void change_nice(int new_val)
{
...
static inline void restore_nice()
{
...
static inline void hold_softirq()
{
    sigset_t block_mask;
...
static inline void restore_softirq()
{
    sigset_t block_mask;
