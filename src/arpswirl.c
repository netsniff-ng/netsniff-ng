...
{
	printf("\narpswirl %s, the arp redirector\n", VERSION_STRING);
	printf("http://www.netsniff-ng.org\n\n");
	printf("Usage: arpswirl [options]\n");
	...
	printf("\n");
	printf("Examples:\n");
	printf("  arpswirl --dev eth0 --flood --prefix 10.0\n");
	printf("  arpswirl --dev eth0 --agressive conn.txt --routing table.txt\n");
	printf("\n");
