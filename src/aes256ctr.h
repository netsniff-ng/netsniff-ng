...
extern struct aes256ctr *aes256ctr_init(const char *key);
extern void aes256ctr_enc(struct aes256ctr *ac, char *buf, int len);
#define aes256ctr_dec aes256ctr_enc
extern void aes256ctr_done(struct aes256ctr *ac);
extern int hmacsha256_init(gcry_md_hd_t * mh, const char *key, int len);
#define aes256cprng aes256ctr
#define aes256cprng_init aes256ctr_init
extern void aes256cprng_fillbuf(struct aes256cprng *cprng, char *buf, int len);
