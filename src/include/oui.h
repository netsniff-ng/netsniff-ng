...
static const struct vendor_id vendor_db[] = {
	...
	{0x000B91,
	 "Aglaia Gesellschaft für Bildverarbeitung und Kommunikation m"},
	...
	{0x001F0A, "Nortel"},
	{0x001F0B,
	 "Federal State Unitary Enterprise Industrial Union \"Electropribor\""},
	...
	{0x60391F, "ABB Ltd"},
	{0x6089B7,
	 "KAEL Mï¿½HENDISLIK ELEKTRONIK TICARET SANAYI Limited ï¿½irketi"},
